...
<?php 
$vericek = $conn -> prepare("SELECT * FROM sehirler where id = :id");
...
if (isset($_POST["Gonder"])) {
  ...
  $guncelle = $conn -> prepare("UPDATE sehirler SET sehirisim=:sehirisim, sehirplaka=:sehirplaka WHERE id=:id");
  $guncelle->bindParam(':id', $ids);
  $guncelle->bindParam(':sehirisim', $sehirisim); 
  $guncelle->bindParam(':sehirplaka', $sehirplaka); 
  $guncelle-> execute(); 
  if($guncelle){
...
if (isset($_GET['numaram'])) {
  ...
  $sehirsil = $conn -> prepare("DELETE FROM sehirler where id = :id");
  $sehirsil->bindParam(':id', $_GET['numaram']);
  $sehirsil-> execute();
  if($sehirsil){
    $mesaj = '<meta http-equiv="refresh" content="2;URL=?sayfa=sehirler">
    <div class="alert alert-dismissible alert-success">
...
<div class="container-fluid">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="?sayfa=sehirler">Şehir Düzenle</a></li>
    <li class="breadcrumb-item active"><?php echo $veriyigoster['sehirisim']; ?></li>
  </ol>
    ...
    <div class="row">
      ...
      <div class="col-xl-8 col-sm-12 mb-3">        
        <div class="input-group mb-3">
          ...
          <input type="text" name="sehirisim" class="form-control" value="<?php echo $veriyigoster['sehirisim']; ?>">
        ...
        <div class="input-group mb-3">
          ...
          <input type="text" name="sehirplaka" class="form-control" value="<?php echo $veriyigoster['sehirplaka']; ?>">
